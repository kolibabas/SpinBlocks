...
public class FloatText {
	...
	public void Draw(Canvas c)
	{
		if (this.Visible)
		{
			...
			c.drawText(chars, 0, Text.length(), Position_World_X, Position_World_Y, outline_paint);
			c.drawText(chars, 0, Text.length(), Position_World_X, Position_World_Y, text_paint);
		}
	}
